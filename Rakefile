...
desc 'seeds data'
task :seed do
  User.create(name: "Austen Hasty", location: "411 4th Ave, Seattle, WA 98101")   #user_id: 1
  User.create(name: "Jens Vyff", location: "411 4th Ave, Seattle, WA 98101")      #user_id: 2
